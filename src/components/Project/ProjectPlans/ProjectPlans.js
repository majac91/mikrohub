        ...
        <Box>
            <Flex pt={{ xs: '39px', md: '95px' }} pb={{ xs: '47px', md: '113px' }} flexDirection={{ xs: 'column', md: 'row' }} justifyContent='space-between'>
                <PlanCard mb={{ xxs: '30px', md: 0 }}>
                    <H3 whiteSpace='nowrap' fontSize={{ xs: '24px', md: '70px' }} mb={{ xxs: '30px', md: '40px' }}>{plans.plan1.title}</H3>
                ...
                <PlanCard>
                    <H3 fontSize={{ xs: '24px', md: '70px' }} mb={{ xxs: '20px', md: '40px' }}>{plans.plan2.title}</H3>
                    <ImgWrapper aspect='94%' mb={{ xxs: '30px', md: '80px' }}>
